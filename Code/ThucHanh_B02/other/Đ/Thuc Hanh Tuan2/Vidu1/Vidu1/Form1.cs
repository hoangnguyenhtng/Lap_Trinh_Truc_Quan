    ...
    public partial class Form1 : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (kt == 1)
            {
                ...
                lbDanhSach.Items.Add(txtMaKH.Text + " | " + txtTenKH.Text + " | " + txtDiaChi.Text+ " | " + dtpNgayGui.Text + " | " + txtSoTienGui.Text + " | " + cbThoiGianGui.Text + " tháng | " + tienlai);



                staticData._NguoiGuis.Add(new NguoiGui(Convert.ToInt32(txtMaKH.Text), txtTenKH.Text, txtDiaChi.Text, Convert.ToInt32(txtSoTienGui.Text),dtpNgayGui.Text, cbThoiGianGui.Text, tienlai));
            }
        }
